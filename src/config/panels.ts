...
// ============================================
// ENERGY VARIANT (Energy Intelligence)
// ============================================
...
// ============================================
function selectVariant<T>(full: T, tech: T, energy: T): T {
  if (SITE_VARIANT === "tech") return tech;
  if (SITE_VARIANT === "energy") return energy;
  return full;
}

export const DEFAULT_PANELS = selectVariant(
  FULL_PANELS,
  TECH_PANELS,
  ENERGY_PANELS,
);
export const DEFAULT_MAP_LAYERS = selectVariant(
  FULL_MAP_LAYERS,
  TECH_MAP_LAYERS,
  ENERGY_MAP_LAYERS,
);
export const MOBILE_DEFAULT_MAP_LAYERS = selectVariant(
