// Tech/AI variant - tech.energy-monitor.app
...
// Tech-specific exports (removed: tech-companies, ai-research-labs, startup-ecosystems, ai-regulations)
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: "Schneier", url: rss("https://www.schneier.com/feed/") },
    {
      ...
      url:
        "https://rss.energy-monitor.app/api/rss-proxy?url=" +
        encodeURIComponent(
