const DEFAULT_REMOTE_HOSTS: Record<string, string> = {
  tech: "https://tech.energy-monitor.app",
  full: "https://energy-monitor.app",
  world: "https://energy-monitor.app",
};
...
const APP_HOSTS = new Set([
  "energy-monitor.app",
  "www.energy-monitor.app",
  "tech.energy-monitor.app",
  "startups.energy-monitor.app",
  "localhost",
  "127.0.0.1",
]);
...
function isAppOriginUrl(urlStr: string): boolean {
  try {
    ...
    return APP_HOSTS.has(host) || host.endsWith(".energy-monitor.app");
  } catch {
    return false;
  }
}
