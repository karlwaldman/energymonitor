...
const LOGO_URL = "/favico/energymonitor-icon-1024.png";
...
export async function renderStoryToCanvas(
  ...
  ctx.fillText("ENERGYMONITOR", textX, y + 26);
  ...
  ctx.fillText("ENERGY-MONITOR.APP", footerTextX, H - 55);
  ctx.letterSpacing = "0px";
  ctx.font = "400 20px Inter, system-ui, sans-serif";
  ctx.fillText("Real-time energy intelligence monitoring", footerTextX, H - 30);
