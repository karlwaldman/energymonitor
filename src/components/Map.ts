...
// Stub type for deleted tech-activity service
type TechHubActivity = {
  lat: number;
  lon: number;
  city: string;
  newsCount: number;
...
// Stubs for deleted config data (empty arrays -- code paths that iterate these will never execute)
const GAMMA_IRRADIATORS: Array<{
  id: string;
  lat: number;
  lon: number;
  city: string;
