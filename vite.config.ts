...
> = {
  world: {
    title: "EnergyMonitor - Real-Time Energy Intelligence Dashboard",
    description:
      "Real-time energy intelligence dashboard with live commodity prices, pipeline maps, vessel tracking, military monitoring, and energy market data powered by OilPriceAPI.",
    keywords:
      "energy intelligence, oil prices, commodity dashboard, pipeline monitoring, energy markets, military bases, vessel tracking, AIS ships, power outages, oil analytics, energy stocks, OSINT, real-time monitoring, situation awareness",
    url: "https://energy-monitor.app/",
    siteName: "EnergyMonitor",
    features: [
  ...
  tech: {
    ...
    url: "https://tech.energy-monitor.app/",
  ...
  return {
    ...
    transformIndexHtml(html) {
      return html
        ...
        .replace(/"name": "EnergyMonitor"/, `"name": "${meta.siteName}"`)
        .replace(
          /"alternateName": "EnergyMonitor"/,
...
export default defineConfig({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "EnergyMonitor - Real-Time Energy Intelligence",
        short_name: "EnergyMonitor",
        description:
          "Real-time energy intelligence dashboard powered by OilPriceAPI",
        start_url: "/",
        scope: "/",
        display: "standalone",
        orientation: "any",
  ...
  server: {
    ...
    proxy: {
      ...
      "/api/polymarket": {
        target: "https://energy-monitor.app",
        changeOrigin: true,
        configure: (proxy) => {
          proxy.on("error", (err) => {
